...
function LoginPageInner() {
  ...
  const onMagicLink = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNotice("Magic link sent. Check your email and come right back.");
    } catch (e: any) {
    ...
    <main className="min-h-screen bg-[#FAF9F7] text-[#1F1F1F]">
      <div className="mx-auto w-full max-w-[560px] px-6 py-14">
        ...
        <div className="rounded-2xl border border-[#EAEAEA] bg-white p-6 shadow-sm">
          ...
          <form onSubmit={mode === "password" ? onPasswordSignIn : onMagicLink} className="space-y-4">
            <div>
          ...
          <div className="mt-5 rounded-xl border border-[#EAEAEA] bg-[#FAF9F7] px-4 py-3 text-sm text-[#6A6A6A]">
            Use password sign-in if you already created credentials in Supabase. Use magic link for
            the fastest setup.
          </div>
        </div>
